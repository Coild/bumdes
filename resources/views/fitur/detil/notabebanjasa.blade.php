            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('post.notabebanjasa') }}" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input name="harga" data-parsley-type="number" type="text" class="form-control" placeholder="Harga Beban" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Jumlah</label>
                        <div class="col-md-8">
                            <input name="jumlah" data-parsley-type="number" type="text" class="form-control" placeholder="Jumlah Beban" required>
                        </div>
                    </div>
