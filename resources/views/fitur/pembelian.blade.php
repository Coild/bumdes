                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="conbtn">
                                                    ...
                                                    <button class="btn btn-success center mdi mdi-eye" style="margin-left: 2%" onclick="window.location.href='{{route('get.notapembelian')}}?id={{ $loop->index}}'" > Detail</button>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('post.pembelian') }}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data">
                    @csrf
